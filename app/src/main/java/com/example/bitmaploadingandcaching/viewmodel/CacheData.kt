...
class CacheData:ViewModel() {
    companion object{
        ...
        fun addList(newContact:Contact,pos:Int){
            ...
            println("CONTACT DATA: $newContact")
            position = pos
        }
        ...
        private fun loadContactList():MutableList<Contact> {
            list.add(
                Contact(
                    ...
                    "98229294892",
                    "Mobile",false,false,false, mutableMapOf()
                )
            )
            list.add(
                Contact(
            ...
            list.add(
                Contact(
                    ...
                    COLORS_LIST[Random.nextInt(0, 10)], "625845242421", "Mobile",false,false,false,
                    mutableMapOf()
                )
            )
            list.add(
            ...
            list.add(
                Contact(
                    ...
                    COLORS_LIST[Random.nextInt(0, 10)], "6523857834", "Mobile",false,false,false,
                    mutableMapOf()
                )
  )
            list.add(Contact(
