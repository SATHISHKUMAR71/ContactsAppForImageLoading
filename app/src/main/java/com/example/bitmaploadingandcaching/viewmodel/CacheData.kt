        ...
        private fun loadContactList():MutableList<Contact> {
            list.add(
                Contact(
                    ...
                    mutableListOf("98229294892"),
                    false,false, mutableListOf("")
                )
            )
            list.add(
                Contact(
            ...
            list.add(
                Contact(
                    ...
                    COLORS_LIST[Random.nextInt(0, 10)], mutableListOf("625845242421"), false,false,
                    mutableListOf("")
                )
            )
            list.add(
            ...
            list.add(
                Contact(
                    ...
                    COLORS_LIST[Random.nextInt(0, 10)], mutableListOf("6523857834"), false,false,
                    mutableListOf("")
                ))
            list.add(Contact(
                    "Clown",
